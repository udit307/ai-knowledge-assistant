...
st.markdown("""
<style>
    /* Force dark background on the main containers */
    [data-testid="stAppViewContainer"], [data-testid="stHeader"] {
        background-color: #0a0a0a !important;
    }
    
    /* The floating gradient glow */
    .bg-glow {
        position: fixed;
        top: 10%;
        right: -10%;
        width: 60vw;
        height: 60vw;
        background: radial-gradient(circle, rgba(14, 77, 146, 0.4) 0%, rgba(0,0,0,0) 65%);
        filter: blur(1px);
        z-index: 0; /* Keeps it behind your text/buttons */
...
<!-- Inject the glow directly into the HTML -->
